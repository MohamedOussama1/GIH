...
//    ////   ============  </rachid>   ============
////    @ManyToOne
////    @JoinColumn(name = "code_etat_entrée")
////    private EtatAmbulance etatAmbulance;
////    @OneToOne
////    @JoinColumn(name = "code_etat_sortie")
////    private EtatAmbulance etatAmbulanceSortie;
//    @Enumerated(EnumType.STRING)
//    private TypeRevision typeRevision;
//
//    public Revision() {
...
//    }
//
//    public EtatAmbulance getEtatAmbulanceSortie() {
//        return etatAmbulanceSortie;
//    }
//
//    public void setEtatAmbulanceSortie(EtatAmbulance etatAmbulanceSortie) {
//        this.etatAmbulanceSortie = etatAmbulanceSortie;
//    }
//
//    public int getId() {
//        return id;
