...
//        Espace salleReanimation = new Salle("reveil",12,  30, radiologie, TypeSalle.SALLE_REVEIL );
//
...
//
//        Espace chambre1 = new Chambre("ch1",41,  30, radiologie, TypeChambre.MULTI );
//        Espace chambre2 = new Chambre("ch2",68,  30, cardiologie, TypeChambre.MULTI );
//        Espace chambre3 = new Chambre("ch3",70,  10, oncologie, TypeChambre.SINGLE );
//
